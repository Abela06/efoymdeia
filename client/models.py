...
VIEWER_STATUS=(('blocked','BLOCKED'),('unset','UNSET'))
...
class Video(models.Model):
    ...
    thumbnailsLocal = models.URLField(max_length=250, blank=True, null=True)
...
class Viewer(models.Model):
    ...
    status=models.CharField(
        max_length=12, choices=VIEWER_STATUS, default='unset')
...
class Section(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, default=Category)
    status = models.CharField(
        max_length=12, choices=PUBLISHED, default='unpublished',null=True)
...
class RadioStation(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=STAT, default='unpublished')
